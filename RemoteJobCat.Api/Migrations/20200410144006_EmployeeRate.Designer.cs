...
namespace RemoteJobCat.Api.Migrations
{
    ...
    [Migration("20200410144006_EmployeeRate")]
    partial class EmployeeRate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RemoteJobCat.Api.Models.InternalRecommendation", b =>
                {
                    ...
                    b.Property<Guid?>("RecommendatorEmployeeId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RecommendatorEmployeeId");
            ...
            modelBuilder.Entity("RemoteJobCat.Api.Models.Employee", b =>
                {
                    b.HasOne("RemoteJobCat.Api.Models.Rate", "Rate")
                        .WithMany()
            ...
            modelBuilder.Entity("RemoteJobCat.Api.Models.InternalRecommendation", b =>
                {
                    b.HasOne("RemoteJobCat.Api.Models.Employee", "RecommendatorEmployee")
                        .WithMany()
                        .HasForeignKey("RecommendatorEmployeeId");

                    b.HasOne("RemoteJobCat.Api.Models.Employee", "RecommendedEmployee")
